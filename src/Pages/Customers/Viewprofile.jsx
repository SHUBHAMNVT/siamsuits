        ...
        <Col lg="10">
          <Dashboardfront />
           <div className="panel-change-boxes">
             ...
             <div className='profile-box-nn col-md-4'>
             <div class="card card-block p-card">
              <div class="profile-box-main">
               <div class="profile-card rounded">
                  <img src={profile} alt="profile-bg" class="avatar-100 rounded d-block mx-auto img-fluid mb-3" />
                        ...
                        <a href="#">
                           <svg width="24" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <g clip-path="url(#clip0)">
                                 <path d="M341.269 85.0133H388.011V3.60533C379.947 2.496 352.213 0 319.915 0C252.523 0 206.357 42.3893 206.357 120.299V192H131.989V283.008H206.357V512H297.536V283.029H368.896L380.224 192.021H297.515V129.323C297.536 103.019 304.619 85.0133 341.269 85.0133V85.0133Z" fill="black"></path>
                              </g>
                              <defs>
                                 <clipPath><rect width="512" height="512" fill="white"></rect></clipPath>
                              </defs>
                           </svg>
                        </a>
                        <a href="#">
